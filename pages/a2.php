...
<div class="sidebar">
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Engine Hall Blok A2</span>
      </div>
      ...
      <div class="home-content">
        ...
        <div class="overview-boxes">
          <div class="judul">
        <?php
        $grafik  = mysqli_query($connect, "SELECT kode_jadwal from jadwal,a2 where a2.jadwal=jadwal.kode_jadwal group by jadwal");
  ...
  <tr style="background-color: #04AA6D;">
    ...
    <th>Work Type</th>
    <?php
              $grafik  = mysqli_query($connect, "SELECT jadwal_1,jadwal_2,jadwal_3,jadwal_4,jadwal_5 FROM jadwal,a2 where a2.jadwal=jadwal.kode_jadwal group by jadwal");
              while ($p = mysqli_fetch_array($grafik)) {
        ?>
  ...
  <?php
               $grafik  = mysqli_query($connect, "SELECT * from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  <?php
               ...
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_1='0',1,null)) as jadwal_1 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_2='0',1,null)) as jadwal_2 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_3='0',1,null)) as jadwal_3 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_4='0',1,null)) as jadwal_4 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_5='0',1,null)) as jadwal_5 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_1='1',1,null)) as jadwal_1 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_2='1',1,null)) as jadwal_2 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_3='1',1,null)) as jadwal_3 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_4='1',1,null)) as jadwal_4 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_5='1',1,null)) as jadwal_5 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_1='2',1,null)) as jadwal_1 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_2='2',1,null)) as jadwal_2 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_3='2',1,null)) as jadwal_3 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_4='2',1,null)) as jadwal_4 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
  ...
  ?>
    ...
    <?php } ?>
       ...
       <?php
               $grafik  = mysqli_query($connect, "SELECT count(if(kondisi_5='2',1,null)) as jadwal_5 from a2");
               while ($p = mysqli_fetch_array($grafik)) {
